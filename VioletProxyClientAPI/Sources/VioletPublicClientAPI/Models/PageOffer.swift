...
public struct PageOffer: Codable, JSONEncodable, Hashable {
    ...
    public init(totalPages: Int? = nil, totalElements: Int64? = nil, size: Int? = nil, content: [Offer]? = nil, number: Int? = nil, sort: Sort? = nil, first: Bool? = false, last: Bool? = false, numberOfElements: Int? = nil) {
