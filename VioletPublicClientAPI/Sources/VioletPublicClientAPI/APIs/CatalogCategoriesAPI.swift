...
open class CatalogCategoriesAPI {
     ...
     */
    @discardableResult
    open class func catalogCategoriesGet(xVioletToken: String, xVioletAppSecret: String, xVioletAppId: Int64, page: Int? = nil, size: Int? = nil, apiResponseQueue: DispatchQueue = VioletPublicClientAPI.apiResponseQueue, completion: @escaping ((_ data: [Category]?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func catalogCategoriesIdGet(xVioletToken: String, xVioletAppSecret: String, xVioletAppId: Int64, id: String, apiResponseQueue: DispatchQueue = VioletPublicClientAPI.apiResponseQueue, completion: @escaping ((_ data: Category?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func catalogCategoriesIdTreeGet(xVioletToken: String, xVioletAppSecret: String, xVioletAppId: Int64, id: String, apiResponseQueue: DispatchQueue = VioletPublicClientAPI.apiResponseQueue, completion: @escaping ((_ data: [Category]?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func catalogCategoriesSearchQueryGet(xVioletToken: String, xVioletAppSecret: String, xVioletAppId: Int64, query: String, page: Int? = nil, size: Int? = nil, apiResponseQueue: DispatchQueue = VioletPublicClientAPI.apiResponseQueue, completion: @escaping ((_ data: [Category]?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func catalogCategoriesSlugSlugGet(xVioletToken: String, xVioletAppSecret: String, xVioletAppId: Int64, slug: String, apiResponseQueue: DispatchQueue = VioletPublicClientAPI.apiResponseQueue, completion: @escaping ((_ data: Category?, _ error: Error?) -> Void)) -> RequestTask {
