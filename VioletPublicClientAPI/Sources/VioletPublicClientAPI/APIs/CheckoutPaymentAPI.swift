...
open class CheckoutPaymentAPI {
     ...
     */
    open class func checkoutCartCartIdPaymentPostWithRequestBuilder(cartId: Int64, xVioletToken: String? = nil, xVioletAppSecret: String? = nil, xVioletAppId: Int? = nil, priceCart: Bool? = nil, body: CartPaymentMethod? = nil) -> RequestBuilder<Order> {
